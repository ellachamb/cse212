public static class ArraysTester {
    ...
    {
        // Initialize the array that is the size of int length
        // Use a for loop to calculate the multiples of the number and store them in the array
        // Return the array
    ...
    private static void RotateListRight(List<int> data, int amount)
    {
        ...
        rotatedList.AddRange(data.GetRange(0, data.Count - rotation));
        data.Clear();
